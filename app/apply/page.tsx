        ...
        <main className="flex flex-col items-center pt-24">
          <GlowingBorder>
            <div className="text-center">
              <h2 className="text-5xl mb-4">Apply for Staff</h2>
              ...
              <a href="#idontknowmuchabtthissorry" target="_blank" rel="noopener noreferrer" className="inline-block px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
                Apply Now
              </a>
            </div>
          </GlowingBorder>
