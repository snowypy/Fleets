  ...
  return (
    ...
    >
        ...
        <GlowingBorder>
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <h3 className="text-xl text-[#46A5C9] font-bold">BLATANT RULES</h3>
              <p className="text-white/80">
            ...
            <div className="space-y-4">
              <h3 className="text-xl text-[#46A5C9] font-bold">PER CASE RULES</h3>
              <p className="text-white/80">
      ...
      <motion.h2 
        ...
        className="text-4xl text-center my-16 tracking-wider"
      >
        DETAILED GUIDELINES
      </motion.h2>
